// Create 250 random features, and give them a "type" attribute that
// will be used for the label text.
var features = new Array(250);
for (var i=0; i<features.length; i++) {
    var randomType = 5 + parseInt(5 * Math.random());
    var labelText = randomType;
    if(randomType % 2 === 0) {
        labelText += ' banana';
    }
    if(randomType % 4 === 0) {
        labelText = 'monkey '+labelText;
    }
