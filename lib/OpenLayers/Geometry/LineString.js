...
OpenLayers.Geometry.LineString = OpenLayers.Class(OpenLayers.Geometry.Curve, {
    ...
    /**
    * Method: offset
    * Create a parallel line at specified offset (in map units)
    * Parameters:
    * offset - Number
    * returnLinestring - Boolean - to return a OpenLayers.Geometry.LineString instance or simple array of coordinates
    * Returns:
    OpenLayers.Geometry.LineString or Array with x,y pairs
    **/

    offset: function(offset,returnLinestring) {
        var offsetCoords = [];
