...
OpenLayers.Renderer.Elements = OpenLayers.Class(OpenLayers.Renderer, {
    ...
    initialize: function(containerID, options) {
        ...
        this.renderingBuffer = document.createDocumentFragment();
    ...
    clearBuffer: function() {
        var child;
        var buf = this.renderingBuffer;
        while(child = buf.firstChild) {
            buf.removeChild(child);
        }
    },

    lock: function() {
        console.log('renderer locked');
        console.time('renderer lock');
        this.locked = true;
    },

    unlock: function() {
       this.vectorRoot.appendChild(this.renderingBuffer);
       this.clearBuffer();
       this.locked = false;
       console.timeEnd('renderer lock');
       console.log('renderer unlocked');
    },
    ...
    redrawNode: function(id, geometry, style, featureId) {
        ...
        if (this.indexer) {
            ...
            if (node.parentNode !== this.vectorRoot){
                if(this.locked) {
                    this.renderingBuffer.appendChild(node);
                }
                else {
                   this.vectorRoot.appendChild(node);
                }
