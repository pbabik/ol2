...
OpenLayers.Control.ModifyFeature = OpenLayers.Class(OpenLayers.Control, {
    ...
    initialize: function(layer, options) {
        ...
        var dragCallbacks = {
            ...
            move: function(pixel,ox,oy, dx, dy) {
                delete this._unselect;
                if (this.vertex) {
                    this.dragVertex(this.vertex, pixel, ox, oy, dx, dy);
                }
            },
            up: function() {
     ...
     * ox - {Float} The original x value.
     * oy - {Float} The original y value.
    ...
    dragVertex: function(vertex, pixel) {
        ...
        var ox = geom.x;
        var oy = geom.y;
        var dx = pos.lon - geom.x;
        var dy = pos.lat - geom.y;
        geom.move(dx,dy);
        this.modified = true;
        /**
         * Five cases:
